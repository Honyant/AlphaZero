...
class ValueHead(nn.Module):
    def __init__(self, in_channels, middle_channels, board_area, intermediate_dim=256):
        super().__init__()
        self.conv = nn.Conv2d(in_channels, middle_channels, kernel_size=1)
        self.bn = nn.BatchNorm2d(middle_channels)
...
class AlphaZeroNet(nn.Module):
    def __init__(self, board_area, num_actions, input_depth, blocks=10, conv_channels=256, head_channels=256, policy_channels=2, value_channels=1):
        super().__init__()
